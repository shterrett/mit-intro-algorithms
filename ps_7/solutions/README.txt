...
We have prepared templates for you in ps7_answers.tex and ps7e_answer.tex.  Please modify
them to include all your answers, except for the Python source code, and then
upload the modified files to Stellar.
